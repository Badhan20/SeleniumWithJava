...
public class C_72_VerifyDesscendingOrderofDropDownValues {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if(tempList.equals(actualList)) {
			...
			System.out.println("The drop-down is sorted in descending order.");
		}
		
		else {
			
			System.out.println("The drop-down is not sorted in descending order.");
		}
